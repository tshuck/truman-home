...
<Text color="muted" id="3" mb={2}>
  ...
  <Footnote id="foot-4" href="#4">
    4
  </Footnote>
  . I've been kicking this idea around with other folks at <i>Hatch</i>, any of whom have as much claim to write their own post. As long as
  they cite me, similarly vaguely, in a footnote.
</Text>
...
<Text color="muted" id="4" mb={2}>
  ...
  Seen again as I coopt Leslie Knope of "Parks and Recreation."
  <Footnote id="foot-5" href="#5">
    5
  </Footnote>
</Text>
