...
<Box fontSize={3}>
  ...
  <Text color="muted" id="1" mb={2}>
    <Link href="#foot-1" color="accent">1:</Link>  This, most, when crossing over a highway; I could follow the out-rushing tail lights anywhere.  I never did.
  </Text>

  <Text color="muted" id="2" mb={2}>
    <Link href="#foot-2" color="accent">2:</Link>  Becoming something like a sophomore-and-a-half over the course of a disparate couple of years that I attended the University of Illinois.  Another story.
  </Text>

  <Text color="muted" id="3" mb={2}>
    <Link href="#foot-3" color="accent">3:</Link>  Duh.
  </Text>

  <Text color="muted" id="4" mb={2}>
    <Link href="#foot-4" color="accent">4:</Link>  I am only partly responsible for this.  I've had countless help from a countable, but large, number of folks.  Friends; a therapist; my partner; a cat who honestly might not know the difference.  I am so grateful.
  </Text>

  <Text color="muted" id="5" mb={2}>
    <Link href="#foot-5" color="accent">5:</Link>  Duh.
  </Text>

  <Text color="muted" id="6" mb={2}>
    <Link href="#foot-6" color="accent">6:</Link>  And often exhausting.
  </Text>

  <Text color="muted" id="7" mb={2}>
    <Link href="#foot-7" color="accent">7:</Link>  Talking to other folks about it helps, too.  As does meditation and self-acceptance.
  </Text>
