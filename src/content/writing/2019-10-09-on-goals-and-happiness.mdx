...
<Box fontSize={3}>
  ...
  I did not often step in to my life when it was hard and when I needed to.  I wrapped discontent, sadness, and irritation in an intellectual mantra:  I don't need to feel this.  It will be okay.  This was my process for existing; I have a habit of over-thinking and under-feeling<Footnote href="#3">3</Footnote>.  In my mid-twenties this slowly stopped working, and I descended in to a semi-functional madness.  My sense of identity was rapidly crumbling. I reached a breaking point, and I felt that I had broken.  I did not wish to die, but in the morning I would pull the covers over my head, and hide, and think about not existing.

  I do not feel broken today.  In my late twenties I began to be reassembled<Footnote href="#4">4</Footnote>.  This process continues.  Here is what I learned:  **happiness itself is not actionable**<Footnote href="#5">5</Footnote>.  Being okay is a direction to travel and, importantly, is an _outcome_ of the structure of my life.  Feeling bad is a deeply helpful signal to understand what I need change and how I need to grow; where I need to assert myself, and how to step in to my life.

  I've kept the pieces that I like:  optimism, patience, kindness.  I've added to my process for existing.  It's still very intellectual<Footnote href="#6">6</Footnote>, and I do a lot of work to understand and incorporate how I feel.  Sometimes it's very easy:  I'm irritable when I'm hungry.  Sometimes it's enough to recognize feeling uneasy because life is uncertain.  Sometimes I have to step in and have a conversation with someone that is wildly uncomfortable.  I have a mental checklist that, so importantly, starts when I actively engage with the thought or feeling that conflicts with _being happy_<Footnote href="#7">7</Footnote>.

  This optimistic thread of my personality began partially as a naive defense mechanism to avoid conflict, and I've had to learn a lot about the work that must be done for it to be a useful part of myself.  I'm still not particularly goal-oriented.  Having goals, and growing, are both skills that I develop slowly.  I am happy, generally, and importantly I know what to do when I'm not.  I don't know that this is helpful advice, only that it's been a gradual realization.

  Thank you for your time and for your attention.

  <Box as="hr" my={4} bg="hr" height="2px" sx={{ border: 'none' }} />

  <Box id="on-happiness-and-goals-footnotes"></Box>

  <Text color="muted" id="1" mb={2}>
    1:  This, most, when crossing over a highway; I could follow the out-rushing tail lights anywhere.  I never did.
  </Text>

  <Text color="muted" id="2" mb={2}>
    2:  Becoming something like a sophomore-and-a-half over the course of a disparate couple of years that I attended the University of Illinois.  Another story.
  </Text>
  ...
  <Text color="muted" id="4" mb={2}>
    4:  I am only partly responsible for this.  I've had countless help from a countable, but large, number of folks.  Friends; a therapist; my partner; a cat who honestly might not know the difference.  I am so grateful.
  </Text>
  ...
  <Text color="muted" id="6" mb={2}>
    6:  And often exhausting.
  </Text>

  <Text color="muted" id="7" mb={2}>
    7:  Talking to other folks about it helps, too.  As does meditation and self-acceptance.
  </Text>
